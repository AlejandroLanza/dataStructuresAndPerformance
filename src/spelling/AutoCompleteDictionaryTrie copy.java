...
public class AutoCompleteDictionaryTrie implements  Dictionary, AutoComplete {
	...
	public boolean addWord(String word)
	{
		...
		TrieNode finalNode = createNodes(word.toLowerCase(), root);
	...
	public boolean isWord(String s) 
	{
		...
		return findWord(s.toLowerCase(), root);
	}
	
	public boolean findWord(String s, TrieNode n) {
		
		if (s.length() == 0) {
			return n.endsWord();
		}
		
		TrieNode nextNode = n.getChild(s.charAt(0));
		
		if (nextNode == null) { return false;}
		
		return findWord(s.substring(1), nextNode);
	}
	/** 
